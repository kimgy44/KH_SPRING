...
public class CookieController {
	...
	public String cookieView(@CookieValue(value="notebook", defaultValue="기본노트북")String notebook
			...
			,@CookieValue(value="emp", defaultValue="7655")String empno
			,@CookieValue(value="coffee", defaultValue="아메리카노")String coffee
			) {
		logger.info("cookieView 호출 성공 : "+notebook);
		logger.info("cookieView 호출 성공 : "+age);
		logger.info("cookieView 호출 성공 : "+empno);
		logger.info("cookieView 호출 성공 : "+coffee);
